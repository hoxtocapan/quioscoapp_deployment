  ...
  return (
    <div className="border p-10 space-y-5">
            ...
            <div key={platillo.id} className="py-3 flex border-b last-of-type:border-0 items-center">
                <div>
                    <Image 
                        ...
                        alt={`Imagen Platilla ${platillo.nombre}`}
                    />
                </div>
      ...
      <div className="md:flex md:items-center md:justify-between my-10">
        <p className="mt-5 font-black text-4xl text-amber-500">Total a pagar: {formaterDinero(total)}</p>
        <button className="bg-indigo-600 hover:bg-indigo-700 text-white mt-5 md:mt-0 py-3 px-10 uppercase font-bold rounded-lg"
            type="button"
